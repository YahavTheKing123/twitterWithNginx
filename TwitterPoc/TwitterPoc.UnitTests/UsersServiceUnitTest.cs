...
namespace TwitterPoc.UnitTests
{
    ...
    public class UsersServiceUnitTest
    {
        ...
        public async Task RegistrationAndLogicTest()
        {
            ...
            var password = "123456";
            var usersService = new UsersService(new UsersRepositoryMock(), new FollowersRepositoryMock());
        ...
        public async Task AddFollowerTest()
        {
            ...
            var usersService = new UsersService(usersRepositoryMock, followersRepositoryMock);
            await Task.WhenAll(
